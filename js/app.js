...
const DESIGNS = [
  ...
  { id: 16, name: 'Space Race World',                    slug: '16-space-race-world',           active: true  },
    ...
    { id: 20, name: 'Jungle Playground',                   slug: '20-jungle-playground',          active: true  },
    { id: 21, name: 'The Jungle',                          slug: '21-the-jungle',                 active: true  },
  { id: 22, name: 'Pets Pets Pets',                      slug: '22-pets-pets-pets',             active: true  },
    { id: 23, name: 'Space Play',                          slug: '23-space-play',                 active: true  },
    { id: 24, name: 'Pool Land',                           slug: '24-pool-land',                  active: true  },
    { id: 25, name: 'Music Playground',                    slug: '25-music-playground',           active: true  },
    { id: 26, name: 'It\'s Raining Food!',                  slug: '26-its-raining-food',           active: true  },
    { id: 27, name: 'Design 27',                        slug: '27-cosy-beach',              active: false },
      { id: 28, name: 'A New Play SPACE',                    slug: '28-a-new-play-space',           active: true  },
      { id: 29, name: 'Turtle Beach',                        slug: '29-turtle-beach',               active: true  },
